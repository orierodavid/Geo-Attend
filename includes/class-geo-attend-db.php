...
class Geo_Attend_DB {
    ...
    public static function activate() {
        ...
        $sql[] = "CREATE TABLE {$t['members']} (id bigint(20) unsigned NOT NULL AUTO_INCREMENT,user_id bigint(20) unsigned NULL,email varchar(190) NULL,department_id bigint(20) unsigned NULL,location_id bigint(20) unsigned NULL,first_name varchar(100) NOT NULL,last_name varchar(100) NOT NULL,pin_hash varchar(255) NOT NULL DEFAULT '',active tinyint(1) NOT NULL DEFAULT 1,created_at datetime NOT NULL,updated_at datetime NOT NULL,PRIMARY KEY (id),UNIQUE KEY user_id (user_id),KEY email (email),KEY department_id (department_id),KEY location_id (location_id),KEY active (active),KEY name_lookup (last_name, first_name)) $charset;";
